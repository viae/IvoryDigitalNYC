					...
					if((isset($flamingo_option['flamingo_blog_share_twitter']) && $flamingo_option['flamingo_blog_share_twitter']) || (isset($flamingo_option['flamingo_blog_share_facebook']) && $flamingo_option['flamingo_blog_share_facebook']) || (isset($flamingo_option['flamingo_blog_share_gplus']) && $flamingo_option['flamingo_blog_share_gplus']) || (isset($flamingo_option['flamingo_blog_share_pinterest']) && $flamingo_option['flamingo_blog_share_pinterest'])){ ?>
