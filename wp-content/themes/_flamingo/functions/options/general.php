...
function vankarwai_options_fields() {
	...
	$flamingo_social_choices = array('- Disabled -','Twitter','Facebook','Gplus','Pinterest','Linkedin','Tumblr','Dribbble','Foursquare','YouTube','Instagram');
	$flamingo_social_values = array(0,'twitter','facebook','google-plus','pinterest','linkedin','tumblr','dribbble','foursquare','youtube','instagram');
